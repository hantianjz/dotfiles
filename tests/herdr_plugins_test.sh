...
grep -Fq 'local HERDR_PLUGIN_DIR = HOME .. "/.config/herdr/plugins/github"' "$repo_root/envy.lua"
grep -Fq 'quote(plugin_id .. "-*")' "$repo_root/envy.lua"
! grep -Fq 'HERDR_BIN .. " plugin list' "$repo_root/envy.lua"
